...
void Zombie::spawn(float startX, float startY, int type, int seed)
{
	...
	case 0:
		...
		m_Texture.loadFromFile("./Resources/graphics/bloater.png");
	...
	case 1:
		...
		m_Texture.loadFromFile("./Resources/graphics/chaser.png");
		m_Sprite.setTexture(m_Texture);
	...
	case 2:
		...
		m_Texture.loadFromFile("./Resources/graphics/crawler.png");
		m_Sprite.setTexture(m_Texture);
...
bool Zombie::hit()
{
	...
	if (m_Health <= 0)
	{
		...
		//load blood.png
		m_Texture.loadFromFile("./Resources/graphics/blood.png");
		m_Sprite.setTexture(m_Texture);
